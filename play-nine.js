var possibleCombinationSum = function(arr, n) {
  ...
  // stars are rerendering every time a number is clicked because the entire Game component is rerendering, so stars are too. randomNumberOfStars must be kept in Game to fix this.
